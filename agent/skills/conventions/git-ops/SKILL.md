...
- A routine commit and fast-forward push is the final step of the work, not a separate request — carry a directed change through to pushed without stopping to confirm. This does not extend to force-push, rewriting published history, or pushing to a shared or protected branch; those stay under the confirmation rule above.
