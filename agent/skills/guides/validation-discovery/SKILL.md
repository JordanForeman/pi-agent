...
- A migration or import that reports success proves the process started, not that your state survived it. Enumerate what you had before — each configured provider, credential, customization — and confirm each one by name on the other side. Liveness is the weakest possible evidence of a correct migration.
